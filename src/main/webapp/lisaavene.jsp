...
<title>Vene lisays</title>
</head>
<body onkeydown="enterWasPressed(event)" class="bg">
<div class="container">
	<div class="header">
		<h1>Add watercraft</h1>
	</div>
	<div class="options">
		<input type="button" class="button button2blue" value="Main page" onclick="goTo()">
	</div>
	<div class="form">		
		<form id="formInfo">
			<div class="formgroup">
			...
			<div class="options">
				...
				<input type="button" class="button button4green" name="Save" id="save" value="Save" onclick="addWatercraft()">
			</div>
